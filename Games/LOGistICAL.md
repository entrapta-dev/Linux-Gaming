...
## Steps
- If you have [Protontricks](https://github.com/Matoking/protontricks) installed you can try `protontricks 573060 -q dotnet472` which is the easiest and fastest way to install all the requirements.  
