...
```
WINEPREFIX=~/.steam/debian-installation/steamapps/compatdata/221680/pfx winetricks sound=alsa
```
...
And finally run:
```
WINEPREFIX=~/.steam/debian-installation/steamapps/compatdata/221680/pfx winecfg
```
